...
function initTree$1(el, walker = walk, intercept = () => {}) {
...
window.Spruce = module_default$3;
module_default$3.magic('fetchedSection', () => {
  return (url, selector) => {
    return async () => {
...
module_default$3.directive('html-if-set', (el, {
  expression
}, {
  effect,
  evaluateLater
...
module_default$3.directive('html-with-slideshow', (el, {
  expression
}, {
  evaluateLater,
  effect,
